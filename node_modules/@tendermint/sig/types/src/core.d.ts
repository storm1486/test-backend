 ...
 */
export declare function createWalletFromMnemonic(mnemonic: string, prefix?: string, path?: string): Wallet;
/**
 ...
 * @throws  will throw if the provided mnemonic is invalid
 */
export declare function createMasterKeyFromMnemonic(mnemonic: string): BIP32Interface;
/**
