...
export class IpfsConnectionFactory {
    static async buildIpfsConnection(mode, network, logger, ipfsEndpoint) {
    ...
    static ipfsHttpAgent(ipfsEndpoint) {
        const agentOptions = {
            keepAlive: false,
            maxSockets: Infinity,
        };
    ...
    static async createGoIPFS(overrideConfig = {}) {
...
//# sourceMappingURL=ipfs-connection-factory.js.map