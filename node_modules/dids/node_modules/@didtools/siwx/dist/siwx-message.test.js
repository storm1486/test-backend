...
const SHORT_MESSAGE = 'service.invalid wants you to sign in with your Ethereum account:\n0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2\n\nI accept the ServiceOrg Terms of Service: https://service.invalid/tos\n\nURI: https://service.invalid/login\nVersion: 1\nChain ID: 1\nNonce: 32891756\nIssued At: 2021-09-30T16:25:24Z';
const WITH_RESOURCES = 'service.org wants you to sign in with your Ethereum account:\n0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2\n\nI accept the ServiceOrg Terms of Service: https://service.org/tos\n\nURI: https://service.org/login\nVersion: 1\nChain ID: 1\nNonce: 32891757\nIssued At: 2021-09-30T16:25:24.000Z\nResources:\n- ipfs://Qme7ss3ARVgxv6rXqVPiikMJ8u2NLgmgszg13pYrDKEoiu\n- https://example.com/my-web2-claim.json';
const BASE_FIELDS = {
...
test('notBefore', ()=>{
    ...
    assert.throws(()=>new SiwxMessage({
            ...BASE_FIELDS,
            notBefore: '2044-99-99T10:14:01Z'
        }));
    assert.ok(new SiwxMessage({
        ...BASE_FIELDS,
        notBefore: undefined
    }));
    assert.ok(new SiwxMessage({
        ...BASE_FIELDS,
        notBefore: '2009-09-09T09:09:01Z'
    }));
});
test('expirationTime', ()=>{
    assert.throws(()=>new SiwxMessage({
    ...
    assert.throws(()=>new SiwxMessage({
            ...BASE_FIELDS,
            expirationTime: '2044-99-99T10:14:01Z'
        }));
    assert.ok(new SiwxMessage({
        ...BASE_FIELDS,
    ...
    assert.ok(new SiwxMessage({
        ...BASE_FIELDS,
        expirationTime: '2009-09-09T09:09:01Z'
    }));
});
test.run();
