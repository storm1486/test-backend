 ...
 * @returns {Factory}
 */
export declare const createFactory: (options?: ControllerOptions, overrides?: ControllerOptionsOverrides) => Factory;
/**
 * Creates a node
 */
export declare const createController: (options?: ControllerOptions) => Promise<Controller>;
...
export declare const createServer: (options?: number | {
    port: number;
}, factoryOptions?: ControllerOptions, factoryOverrides?: ControllerOptionsOverrides) => Server;
