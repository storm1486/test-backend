 ...
 * @module types
 */
import type { ModelAccountRelationV2, ModelDefinition, ModelViewsDefinitionV2 } from '@ceramicnetwork/stream-model';
...
export type CustomRuntimeScalarType = 'accountid' | 'chainid' | 'cid' | 'commitid' | 'countrycode' | 'date' | 'datetime' | 'did' | 'duration' | 'id' | 'latitude' | 'localdate' | 'locale' | 'localtime' | 'longitude' | 'streamid' | 'time' | 'timezone' | 'uri' | 'utcoffset';
type RuntimeStringScalarType<Type extends CustomRuntimeScalarType> = RuntimeScalarCommon & {
    type: Type;
    maxLength?: number;
};
/** Runtime scalar representations. */
export type RuntimeScalar = RuntimeBooleanScalar | RuntimeIntegerScalar | RuntimeFloatScalar | RuntimeStringScalar | RuntimeStringScalarType<CustomRuntimeScalarType>;
/** Runtime scalar types. */
export type RuntimeScalarType = RuntimeScalar['type'];
/** Runtime references types. */
export type RuntimeReferenceType = 'connection' | 'enum' | 'node' | 'object';
/** Runtime reference representation. */
export type RuntimeReference<T extends RuntimeReferenceType = RuntimeReferenceType> = RuntimeScalarCommon & {
    type: 'reference';
    refType: T;
    refName: string;
};
...
export type RuntimeObjectField = RuntimeScalar | RuntimeList | RuntimeReference | RuntimeMetaField | RuntimeViewField;
